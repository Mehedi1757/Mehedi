...
* `apt update`
* `apt install git -y`
* `git clone git://github.com/Mehedi1757/Mehedi.git`
* `cd mehedi`
#### > SETUP : `bash setup`
...
## Single Command :
```
apt update ; apt install git -y ; git clone git://github.com/Mehedi1757/mehedi.git ; cd mehedi ; bash setup ; bash mehedi
```
<br>
<p align="center">
